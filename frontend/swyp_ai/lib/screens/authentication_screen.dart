            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: CustomTheme.theme.textTheme.bodyLarge?.copyWith(color: CustomTheme.disabledColor),
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => GenreSelectionScreen()));
                    },
                    child: const Text(
                      'Sign In',
                      style: TextStyle(
                ...
                Row(
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text(
                        "Or continue with",
                        style: TextStyle(color: CustomTheme.disabledColor), // Customize as needed
                      ),
                    ),
                    Expanded(
                      child: Divider(
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        icon: const Icon(Icons.g_mobiledata_sharp, color: CustomTheme.textColor),
                        label: const Text('Google',
                            style: TextStyle(color: CustomTheme.textColor, fontWeight: FontWeight.w500, fontSize: 16)),
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        icon: const Icon(Icons.apple, color: CustomTheme.textColor),
                  ...
                  child: Row(
                    ...
                    children: [
                      const Text(
                        ...
                        style: TextStyle(color: CustomTheme.disabledColor, fontSize: 16),
                      ),
                      TextButton(
                        onPressed: () {},
                        child: Text(
